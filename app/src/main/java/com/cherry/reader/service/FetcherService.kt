...
package com.cherry.reader.service
...
import com.cherry.reader.App.Companion.context
import com.cherry.reader.data.entities.Entry
import com.cherry.reader.data.entities.Feed
import com.cherry.reader.data.entities.Task
import com.cherry.reader.data.entities.toDbFormat
import com.cherry.reader.data.utils.PrefConstants
import com.cherry.reader.ui.main.MainActivity
...
class FetcherService : IntentService(FetcherService::class.java.simpleName) {
    ...
    companion object : AnkoLogger {
        ...
        const val ACTION_REFRESH_FEEDS = "com.cherry.reader.REFRESH"
        const val ACTION_MOBILIZE_FEEDS = "com.cherry.reader.MOBILIZE_FEEDS"
        const val ACTION_DOWNLOAD_IMAGES = "com.cherry.reader.DOWNLOAD_IMAGES"
