...
import com.cherry.reader.utils.FILE_SCHEME
import com.cherry.reader.utils.HtmlUtils
import com.cherry.reader.utils.UTF8
import com.cherry.reader.utils.getPrefBoolean
import com.cherry.reader.utils.getPrefString
...
class EntryDetailsView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : WebView(context, attrs, defStyleAttr) {
    ...
    init {
        ...
        val fontSize = context.getPrefString(PrefConstants.FONT_SIZE, "1")!!.toInt()
        if (fontSize != 0) {
            ...
            override fun shouldOverrideUrlLoading(view: WebView, url: String): Boolean {
                try {
                    if (url.startsWith(FILE_SCHEME)) {
                        ...
                        val contentUri = getUriForFile(context, "com.cherry.reader.fileprovider", file)
